...
NovaWhisper превращает глобальную горячую клавишу в быстрый и приватный голосовой ввод для Windows: зажмите сочетание, говорите в любом приложении — и вставляйте обработанный текст точно в позицию курсора.

[English](README.md) · **Русский**

</div>

> **Только Windows 11.** Запускайте приложение из репозитория командой `cargo run -p whispr-desktop`. Запуск скопированного отдельного `.exe` не поддерживается, если рядом с ним нет sidecar `whispr-gateway`.

## Посмотрите, как это работает

Используйте изображения ниже как визуальный обзор рабочего процесса.

![Общий обзор NovaWhisper](assets/ScreenCapture.gif)

### 1. Диктуйте в любом приложении

![Демонстрация голосового ввода NovaWhisper](assets/1.png)

### 2. Проверяйте и вставляйте текст

![Запись и расшифровка NovaWhisper](assets/2.png)

### 3. Настройка из меню в трее

![Меню в трее и настройки NovaWhisper](assets/3.png)

### 4. Подготовьте микрофон и провайдер

![Настройки NovaWhisper и выбор ввода](assets/4.png)

### 5. Выберите модель распознавания

![Выбор модели NovaWhisper](assets/5.png)

### 6. Выберите способ вставки

![Настройки вставки NovaWhisper](assets/6.png)

### 7. Сохраните и примените изменения

![Сохранённые настройки NovaWhisper](assets/7.png)

### 8. Запустите диктовку из приложения

![Запуск диктовки NovaWhisper](assets/8.png)

### 9. Остановитесь и дождитесь распознавания

![Остановка записи и обработка речи NovaWhisper](assets/9.png)

### 10. Используйте готовый текст

![Готовый текст NovaWhisper](assets/10.png)
