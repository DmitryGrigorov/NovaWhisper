...
NovaWhisper превращает глобальную горячую клавишу в быстрый приватный голосовой ввод: зажмите сочетание, говорите в любом приложении — и обработанный текст появится точно в позиции курсора.
...
### 2. Говорите, проверяйте, вставляйте

![Запись и расшифровка NovaWhisper](assets/1.gif)

### 3. Настройка из меню в трее

![Меню в трее и настройки NovaWhisper](assets/menu.gif)
