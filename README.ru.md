...
NovaWhisper превращает hotkey в быстрый и приватный голосовой ввод для Windows/MacOS/Linux (Ubuntu): зажмите сочетание, говорите в любом приложении — и вставляйте обработанный текст точно в позицию курсора.
